		...
		<div class="row">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Hapus Data Peserta</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal"  action="phpCode/action_t_pegawai.php?action=delete" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama_lengkap" placeholder="Nama Lengkap" disabled>
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
	                <button type="submit" onclick="history.go(-1); return false;" class="btn btn-default">Batal</button>
	                <button type="submit" class="btn btn-info pull-right">Hapus</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
